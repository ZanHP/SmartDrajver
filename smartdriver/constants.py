...
sh = SCREEN_HEIGHT
sw = SCREEN_WIDTH
#TRACK1 = list(map(lambda x : [sw*x[0], sh*x[1]], [[0.1,0.1], [0.1, 0.2], [0.2, 0.1],[0.1,0.1]]))
...
#TRACK1 = list(map(lambda x : [sw*x[0], sh*x[1]], [[0.1,0.2], [0.12, 0.3], [0.1, 0.4], [0.1, 0.5], [0.1, 0.6], [0.2,0.7], [0.2,0.6], [0.2,0.5], [0.25,0.55], [0.2,0.4],[0.18,0.3], [0.1,0.2]]))
